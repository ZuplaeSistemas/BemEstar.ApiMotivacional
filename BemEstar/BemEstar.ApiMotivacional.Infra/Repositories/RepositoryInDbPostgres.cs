...
namespace BemEstar.ApiMotivacional.Infra.Repositories
{
    ...
    { 
        ...
        public RepositoryInDbPostgres(IDbConnectionFactory connectionFactory)
        {
            _connectionFactory = connectionFactory;
        }
        public int Create(T entity)
        {   //pega conexão com postgrel
            using NpgsqlConnection connection = (NpgsqlConnection)this._connectionFactory.GetConnection();
